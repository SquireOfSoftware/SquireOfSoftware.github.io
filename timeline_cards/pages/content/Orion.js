...
export default function OrionPage(props) {
  return (
    <>
      ...
      <h3 className={styles.sticky_heading}>What was this built with?</h3>
      <p>
      ...
      <h3 className={styles.sticky_heading}>What was architecture of this project?</h3>
      <p>
        Here is our architecture diagram:
      </p>
      <img className={styles.image} src="/images/orion/Orion System Design.png"/>
      <p>
      ...
      <iframe className={styles.embedded_video} width="560" height="560" src="https://www.youtube.com/embed/f0Sk-_4wVZo" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      <p>
      ...
      <h3 className={styles.sticky_heading}>What was your role with this?</h3>
      <p>
      ...
      <iframe className={styles.embedded_video} width="560" height="400" src="https://www.youtube.com/embed/videoseries?list=PLFE1soEirSeYSN21s1mMcTJl_1ayu5DAi" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      <p>
